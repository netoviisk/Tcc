...
class Usuarios(AbstractBaseUser, PermissionsMixin):
    ...
    imagem_perfil = models.ImageField(upload_to='perfil/', blank=True, null=True, default='perfil/profile_icon.png')
    imagem_capa = models.ImageField(upload_to='capa/', blank=True, null=True, default='capa/fundo.png')
